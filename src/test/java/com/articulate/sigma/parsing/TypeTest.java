...
public class TypeTest {
    ...
    public void test1() {
        ...
        String expected = "{?R=[Predicate], ?ARG=[Integer, PositiveInteger], ?N=[Quantity], ?VAL=[Quantity]}";
    ...
    public void test2() {
        ...
        String expected = "{?OBJ=[SelfConnectedObject, Entity], ?PART2=[Object], ?PART1=[Object]}";
        String result = process(input,expected);
        assertEquals(expected,result);
    }
}
